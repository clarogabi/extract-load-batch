-- MySql DDL script for the SAMPLE_APP schema
...
(
    ...
    CONSTRAINT `ORDERS_STATUS_C` CHECK ((`ORDER_STATUS` in
                                         (_utf8mb4'CANCELLED', _utf8mb4'COMPLETE', _utf8mb4'OPEN', _utf8mb4'PAID', _utf8mb4'REFUNDED',
                                          _utf8mb4'SHIPPED')))
) ENGINE=InnoDB;
...
(
    ...
    UNIQUE KEY `ORDER_ITEMS_ORDER_U` (`ORDER_ID`,`LINE_ITEM_ID`),
