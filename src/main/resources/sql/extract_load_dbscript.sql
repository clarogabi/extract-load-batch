...
ALTER TABLE EXTRACT_LOAD_BATCH.EL_DATA_BUNDLE
    ADD (CONSTRAINT FK_SOURCE_DATASOURCE FOREIGN KEY (SOURCE_DATASOURCE_CONFIG_UID)
        REFERENCES EXTRACT_LOAD_BATCH.EL_DATASOURCE_CONFIGURATION (DATASOURCE_CONFIGURATION_UID));
...
-- INSERT INTO EXTRACT_LOAD_BATCH.EL_DATASOURCE_CONFIGURATION (DATASOURCE_CONFIGURATION_UID, DATABASE_NAME,DATABASE_PROVIDER,DATABASE_PLATFORM,DATABASE_CONNECTION_URL,DATABASE_USER_NAME,DATABASE_PASSWORD,DRIVER_CLASS_NAME,DATABASE_DIALECT,DATABASE_SCHEMA,CREATE_DATE_TIME,UPDATE_DATE_TIME)
-- VALUES (EXTRACT_LOAD_BATCH.EL_DATASOURCE_CONFIG_SEQ.nextval, 'DUMMY_SOURCE','ORACLE','dummy','dummy','dummy','dummy','dummy','dummy','dummy',TIMESTAMP '2022-09-18 13:44:07.388000',TIMESTAMP '2022-09-18 13:44:11.435000');
--
-- INSERT INTO EXTRACT_LOAD_BATCH.EL_DATASOURCE_CONFIGURATION (DATASOURCE_CONFIGURATION_UID, DATABASE_NAME,DATABASE_PROVIDER,DATABASE_PLATFORM,DATABASE_CONNECTION_URL,DATABASE_USER_NAME,DATABASE_PASSWORD,DRIVER_CLASS_NAME,DATABASE_DIALECT,DATABASE_SCHEMA,CREATE_DATE_TIME,UPDATE_DATE_TIME)
-- VALUES (EXTRACT_LOAD_BATCH.EL_DATASOURCE_CONFIG_SEQ.nextval, 'DUMMY_TARGET','ORACLE','dummy','dummy','dummy','dummy','dummy','dummy','dummy',TIMESTAMP '2022-09-18 13:44:07.388000',TIMESTAMP '2022-09-18 13:44:11.435000');
--
-- INSERT INTO EXTRACT_LOAD_BATCH.EL_DATA_BUNDLE (DATA_BUNDLE_UID,SOURCE_DATASOURCE_CONFIG_UID,TARGET_DATASOURCE_CONFIG_UID,DATA_BUNDLE_NAME,CREATE_DATE_TIME,UPDATE_DATE_TIME)
-- VALUES (EXTRACT_LOAD_BATCH.EL_DATA_BUNDLE_SEQ.nextval,1,2,'APP',TIMESTAMP '2022-09-18 13:49:25.974000',TIMESTAMP '2022-09-18 13:49:29.709000');
--
-- INSERT INTO EXTRACT_LOAD_BATCH.EL_APP_TABLE (APP_TABLE_UID,APP_TABLE_PHYSICAL_NAME,CREATE_DATE_TIME,UPDATE_DATE_TIME)
-- VALUES (EXTRACT_LOAD_BATCH.EL_APP_TABLE_SEQ.nextval,'APP_USER',TIMESTAMP '2022-09-18 13:52:01.275000',TIMESTAMP '2022-09-18 13:52:06.587000');
--
-- INSERT INTO EXTRACT_LOAD_BATCH.EL_BUNDLED_APP_TABLE (BUNDLE_APP_TABLE_UID,DATA_BUNDLE_UID,SOURCE_APP_TABLE_UID,TARGET_APP_TABLE_UID,RELATIONAL_ORDERING_NUMBER,CREATE_DATE_TIME,UPDATE_DATE_TIME)
-- VALUES (EXTRACT_LOAD_BATCH.EL_BUNDLED_APP_TABLE_SEQ.nextval,1,1,1,1,TIMESTAMP '2022-09-18 13:53:39.324000',TIMESTAMP '2022-09-18 13:53:42.918000');
